...
def upgrade(account, proxy, new_implementation_address, proxy_admin_contract=None, initializer=None, *args):
    ...
    if proxy_admin_contract:
        if initializer:
            ...
            transaction = proxy_admin_contract.upgradeAndCall( # Upgrade and call if initializer and proxy admin
                proxy.address,
            ...
            transaction = proxy_admin_contract.upgrade( # Upgrade if only proxy admin but no initializer
